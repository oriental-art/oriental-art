...
Creating a successful monochrome glaze is technically demanding. The glaze must be perfectly even, without streaks, spots, or variations in color. The surface must be smooth and lustrous. The form must be elegant and precisely executed. Any flaw is immediately visible, as there is no decoration to distract the eye.

This technical challenge is precisely why monochrome wares were valued. They demonstrated the potter's mastery and the imperial workshop's ability to achieve perfection. The wastage rate in production was enormous—pieces with the slightest imperfection were destroyed, making surviving examples rare and precious.
