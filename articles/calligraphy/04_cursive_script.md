# Cursive Script: The Ultimate Expression of Freedom in Chinese Calligraphy
...
![张旭草书 - 狂草代表作](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Zhang_Xu_cursive_script.jpg/800px-Zhang_Xu_cursive_script.jpg)
*张旭草书 - 狂草代表作*

![怀素自叙帖](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8f/Huaisu_Autobiography.jpg/800px-Huaisu_Autobiography.jpg)
*怀素自叙帖*


The origins of cursive script can be traced to the Han dynasty (206 BCE-220 CE), when the demands of administrative efficiency led to the abbreviation of complex seal and clerical script characters. Scribes writing quickly naturally connected strokes and simplified forms, creating an early form of cursive that remained largely legible.

The transformation from practical shorthand to high art occurred during the Wei and Jin periods (220-420 CE), when scholars like Wang Xizhi and his son Wang Xianzhi elevated cursive writing to unprecedented levels of sophistication. The younger Wang, in particular, pushed the script toward greater abstraction, developing what became known as "wild cursive" (*kuangcao*) in contrast to his father's more restrained "modern cursive" (*jincao*).

The Tang dynasty (618-907 CE) saw the emergence of the two figures most associated with wild cursive: Zhang Xu and Huaisu. Both were known for their eccentric personalities as much as their artistic achievements. Zhang Xu was said to write only when drunk, while Huaisu, a Buddhist monk, would sometimes write on temple walls using his hair as a brush. Their works represent the extreme of cursive abstraction, where characters become nearly illegible but the energy and emotion of the writing achieve an almost musical intensity.
