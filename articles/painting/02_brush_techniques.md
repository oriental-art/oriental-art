# The Art of the Brush: Techniques in Chinese Ink Painting
...
![笔墨技法示范](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Ink_wash_techniques.jpg/800px-Ink_wash_techniques.jpg)
*笔墨技法示范*

![笔法示范](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Brush_strokes_demo.jpg/800px-Brush_strokes_demo.jpg)
*笔法示范*


The Chinese painting brush is held differently from Western brushes, and this difference shapes everything that follows. The brush is held perpendicular to the paper, not angled, with the wrist and arm positioned to allow full range of motion. The grip is loose but controlled, allowing the brush to move with the freedom of a dancer while maintaining the precision of a surgeon.

**Central stroke** (*zhongfeng*) keeps the brush tip in the center of the stroke, creating lines of great vitality and strength. This technique, borrowed from calligraphy, is fundamental to all Chinese painting. The brush moves like a snake, the tip always leading, creating strokes that seem to pulse with internal energy.

**Side stroke** (*cefeng*) tilts the brush to use its side, creating broader, flatter marks. This technique is essential for filling areas, creating texture, and suggesting volume. The transition between central and side stroke, executed in a single movement, allows for extraordinary variation.

**Pressing and lifting** (*ti an*) control line weight. Pressing down creates thick, heavy strokes; lifting produces thin, delicate lines. Master painters can modulate pressure within a single stroke, creating effects of three-dimensional form and dramatic emphasis.

**Speed variation** adds another dimension. Fast strokes suggest energy and spontaneity; slow strokes convey weight and deliberation. The same brush, moving at different speeds, creates completely different effects on the absorbent Xuan paper.
