...
The five shades, arranged from darkest to lightest, are:

**Charcoal Black (Jiao)** represents the darkest, most concentrated ink. When the brush is fully loaded with rich, fresh ink, it produces strokes of intense saturation that command attention and convey strength. This shade is used for emphasis, for creating contrast, and for establishing the structural backbone of a composition.

**Thick Black (Nong)** is slightly lighter than charcoal black but still represents heavy, substantial ink. It creates a sense of weight and permanence, suggesting the enduring nature of what is written. In landscape painting, thick black defines the solid masses of mountains; in calligraphy, it gives characters their architectural presence.

**Heavy Black (Zhong)** occupies the middle range of the ink spectrum. It is the workhorse of the calligrapher, suitable for most strokes and characters. Heavy black has depth without overwhelming darkness, clarity without harshness. It represents balance and moderation, the Confucian ideal of the middle way.

**Light Black (Dan)** introduces a note of delicacy and subtlety. Made by using ink that has been slightly diluted or by using a brush with less ink, light black creates an effect of distance, atmosphere, and refinement. It suggests things that are present but not forceful, ideas that are hinted at rather than declared.

**Clear Ink (Qing)** is the palest shade, barely distinguishable from the white paper. It requires the most skill to use effectively, as it demands perfect control of brush and water. Clear ink creates an ethereal, dreamlike quality, suggesting mist, memory, or the boundaries of perception. It represents the Daoist ideal of emptiness that is full of potential.
