# The Art of the Handscroll: Painting as Journey
...
Handscrolls typically measure between 25 and 50 centimeters in height but can extend for many meters in length. They are mounted on stiff paper or silk backing with wooden rollers at each end. The right roller, around which the scroll is wound, is often decorated with ivory, jade, or carved wood. The left roller, used for rolling the scroll after viewing, is usually simpler.

The materials of handscrolls require careful conservation. Silk and paper are vulnerable to light, humidity, and insects. Pigments may fade or change color over time. The mounting, which holds the painting together, may deteriorate and require remounting—a process that risks damaging the original work.

Because of their fragility, handscrolls are not displayed permanently. They are stored in protective boxes and brought out only for occasional viewing, often in the company of friends. This limited accessibility adds to their value and mystique.
