---
name: jd-shopping
description: Help users decide when JD.com is a strong shopping choice based on product type, trust needs, delivery expectations, and brand/store preference. Use when the user asks whether JD is suitable, how JD compares with other Chinese shopping platforms, or where to buy branded electronics, appliances, daily goods, or standardized products.
---

# JD Shopping

Help users judge when JD.com is the right platform based on public shopping factors.
...
- `references/platform-fit.md` for supporting guidance
